    ...
    return (
        <div>
            <div className="bg-[var(--p-bg)] border-2 flex justify-between items-center">
                <img src="/logo.png" className=" w-[3rem] h-[3rem] md:w-[4rem] md:h-[4rem] mx-4"
                    onClick={() => {
                        router.push('/');
                    }
                    }></img>
                ...
                isSignedIn && 
                (
                    <div className="hidden md:flex justify-center items-center mx-4 cursor-pointer">
                        <img src={img_data?img_data:'/default_profile.png'} className="w-[3rem] h-[3rem] md:w-[4rem] md:h-[4rem] rounded-full mx-3" onClick={() => CheckAndDirect("/profile")}></img>
                ...
                isOpen && (
                    <div className="absolute shadow-xl top-0 left-0 w-full h-full bg-[var(--p-bg)] flex flex-col justify-start space-y-8 items-center z-50">
                        ...
                        </div>
                        {
                            isSignedIn && (
                                <div className="flex flex-col justify-center items-center mx-4 cursor-pointer">
                                    <img src={img_data?img_data:'default_profile.png'} className="w-[4rem] h-[4rem] rounded-full my-2" onClick={() => CheckAndDirect("/profile")}></img>
                                    <p className="text-md text-[var(--sec-bg)] font-semibold my-2">{name}</p>
                                    <Button className="bg-red-800 text-sm md:text-lg" onClick={logoutHandler}>Log Out</Button>
                                </div>
                            )
                        }
                        <div
                            ...
                            <p className="cursor-pointer text-md p-2 text-slate-700 font-semibold">Train Details</p>
                        </div>
                        <div
